...
class ProductService {
  getProduct = function(productId: number, res: Response) {
    ...
    return ProductModel.getProduct(productId)
      ...
      .catch(function(err) {
        ...
        return res
          .status(500)
          .send({ error: "An error occured when getting the product" });
      });
  };
  ...
  getProducts = function(res: Response) {
    ...
    return ProductModel.getProducts(filter)
      .then(products => {
      ...
      .catch(function(err) {
        ...
        return res.status(500).send({
          error: "An error occured when getting the products: " + err
        });
      });
  };
  ...
  createProduct = function(product: any, res: Response) {
    ...
    return ProductModel.createProduct(dbProduct)
      .then(createdProduct => {
      ...
      .catch(function(err) {
        logger.error(err);
        return res.status(500).send({
          error: "An error occured when creating the product: " + err
        });
      });
  };
  ...
  updateProduct = function(product: any, res: Response) {
    ...
    return ProductModel.updateProduct(dbProduct.id, dbProduct)
      .then(updatedProduct => {
      ...
      .catch(function(err) {
        logger.error(err);
        return res.status(500).send({
          error: "An error occured when updating the product: " + err
        });
      });
  };
